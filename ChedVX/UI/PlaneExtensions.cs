...
namespace ChedVX.UI
{
    public static class PlaneExtensions
    {
        ...
        /// <summary>
        /// Determine whether a point is contained within a beizier.
        /// </summary>
        /// <param name="vertexes">Array containing vertices</param>
        /// <param name="point">Coordinate to determine</param>
        /// <returns>True if the coordinate is contained within a polygon</returns>
