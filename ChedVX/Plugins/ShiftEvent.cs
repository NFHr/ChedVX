...
namespace ChedVX.Plugins
{
    ...
    {
        public string DisplayName => "Shift event";
        ...
        public void Run(IScorePluginArgs args)
        {
            ...
            {
                MessageBox.Show("The events to be moved overtakes the preceding event.", DisplayName, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
